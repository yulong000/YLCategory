...
ss.source_files  =   'YLCategory/UIAlertController/*.{h,m}','YLCategory/Others/Macro.h'
end
...
ss.source_files  =   'YLCategory/UIViewController/*.{h,m}','YLCategory/UIAlertController/*.{h,m}'
end
